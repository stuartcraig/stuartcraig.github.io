...
_with Zack Cooper, Martin Gaynor, and John Van Reenen_
  <div class="btn-group btn-group-sm">
    ...
    <button type="button" class="btn btn-primary collapsed" data-toggle="collapse" data-target="#QJEabstract" aria-expanded="false" aria-controls="QJEabstract">Abstract</button>
